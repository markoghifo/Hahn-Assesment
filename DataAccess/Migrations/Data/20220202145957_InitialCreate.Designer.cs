...
namespace DataAccess.Migrations.Data
{
    ...
    [Migration("20220202145957_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Business.Entities.CategoryFeatureOptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Business.Entities.ProductFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Business.Entities.CategoryFeatureOptions", b =>
                {
                    b.HasOne("Business.Entities.Category", null)
                        .WithMany("Features")
            ...
            modelBuilder.Entity("Business.Entities.ProductFeatures", b =>
                {
                    b.HasOne("Business.Entities.Product", null)
                        .WithMany("Features")
