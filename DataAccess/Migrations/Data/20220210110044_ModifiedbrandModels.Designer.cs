...
namespace DataAccess.Migrations.Data
{
    ...
    [Migration("20220210110044_ModifiedbrandModels")]
    partial class ModifiedbrandModels
    {
            ...
            modelBuilder.Entity("Business.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 10, 12, 0, 44, 834, DateTimeKind.Local).AddTicks(6172));
