...
namespace DataAccess.Migrations.Data
{
    ...
    [Migration("20220210091413_AddedProductSerialNumbers")]
    partial class AddedProductSerialNumbers
    {
            ...
            modelBuilder.Entity("Business.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 10, 10, 14, 13, 493, DateTimeKind.Local).AddTicks(5956));
